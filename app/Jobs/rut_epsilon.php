...
class rut_epsilon implements ShouldQueue
{
    ...
    public function handle()
    {
        try
        {
            ...
            $rut_21 = (new \App\Jobs\rut_21($this->session_id))->onQueue('deterioration_rut');
            dispatch($rut_21);
        }
        catch (\Exception $e)
        {
            \Log::info('rut_epsilon');
    ...
    private function _writeExcel()
    {
        ...
        $sheet3->data('G5',ucwords($link).'(mm)');
        ...
        $sheet5->data('G5',ucwords($link).'(mm)');
        //load data Hazard rate
        ...
        $sheet7->data('G5',ucwords($link).'(mm)');
        //load data Hazard rate
