...
class budget_simulation_output3 extends BudgetExcel implements ShouldQueue
{
    ...
    public function handle()
    {
    	try
        {
            ...
            $log = [$rec->log_text, date('Y-m-d H:i:s') . ': budget_simulation_output3.'];
        ...
        {
            \Log::info('budget_simulation_output3');
