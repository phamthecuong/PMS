...
class rut_section_32 implements ShouldQueue
{
    ...
    private function _formatExcel()
    {
        ...
        $merge_cell = simplexml_load_string('<mergeCells count="2"><mergeCell ref="I1:'.chr(ord('I')+ $case-2).'1"/><mergeCell ref="'.Helper::covertChr($case).'1"/></mergeCells>');
