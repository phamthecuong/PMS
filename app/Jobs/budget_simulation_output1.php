...
class budget_simulation_output1 extends BudgetExcel implements ShouldQueue
{
    ...
    public function handle()
    {
    	try
        {
            ...
            $log = [$rec->log_text, date('Y-m-d H:i:s') . ': budget_simulation_output1.'];
        ...
        {
            \Log::info('budget_simulation_output1');
