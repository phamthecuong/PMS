...
class crack_32 implements ShouldQueue
{
    ...
    public function handle()
    {
        try
        {
            ...
            $crack_section_32 = (new \App\Jobs\crack_section_32($this->session_id))->onQueue('deterioration_crack');
            dispatch($crack_section_32);
        }
        catch (\Exception $e)
        {
            \Log::info('crack_32');
