...
class crack_route_21 implements ShouldQueue
{
    ...
    public function handle()
    {
        try
        {
            ...
            $crack_22 = (new \App\Jobs\crack_22($this->session_id))->onQueue('deterioration_crack');
            dispatch($crack_22);
        }
        catch (\Exception $e)
        {
            \Log::info('crack_route_21');
