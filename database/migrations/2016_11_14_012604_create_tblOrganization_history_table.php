...
class CreateTblOrganizationHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblOrganization_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tblOrganization_history');
    }
}
