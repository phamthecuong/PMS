...
class CreateTblRMDHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblRMD_history', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('construct_year',6);
            $table->string('service_start_year',6);
