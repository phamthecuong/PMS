...
@section('side_menu_data_review_tool_maintenance_history')
    active
@endsection
...
@section('content')
    ...
    <section id="widget-grid">
        <div class="row">
        <form method="POST" id="export_data" action="/maintenance_history/data_review_tool">
                ...
                <div>
                    <div class="widget-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <header>
                                    <h4><b>{!! trans('review_tool.check_total_width_repair_lane') !!}</b></h4>
                                    <hr/>
                                </header>
                                <div class="row">
                                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                {!! Form::lbCheckbox('time_data_one', '', trans('review_tool.completion_date'), [
                                    'ng-model' => 'formDT.time_data.one',
                                    'ng-true-value' => 1,
                                    'ng-false-value' => 0
                                ]) !!} 
                                {!! Form::lbCheckbox('time_data_two', '', trans('review_tool.repair_duration'), [
                        	...
                        	<div class="col-lg-6">
                            	<header>
                                    <h4><b>{!! trans('review_tool.check_distance') !!}</b></h4>
                                    <hr/>
                                </header>
                            	<div class="row">
                                	<div class="col-lg-6">
                                		@include('custom.form_number', [
                                            'name' => 'distance_min',
                                            'title' => trans('review_tool.distance_min'),
                                            'value' => '',
                                            'model_name' => 'formDT.distance_min',
                                        ])
                                	</div>
                                	<div class="col-lg-6">
                                		@include('custom.form_number', [
                                            'name' => 'distance_max',
                                            'title' => trans('review_tool.distance_max'),
                                            'value' => '',
                                            'model_name' => 'formDT.distance_max',
                                        ])
                                	</div>
                                </div>
                            </div>
                        ...
                        <div class="widget-footer">
                            <button type="button" class="btn btn-primary" ng-click="submitForm()">{!! trans('back_end.submit') !!}</button>
                        </div>
                    </div>
                </div>
                @box_close()
                ...
                <div>
                    <div class="widget-body no-padding table-responsive">
                        ...
                        @include("custom.table_extra_data", [
                            'table_id' => 'mh_tool',
                            'url' => "/ajax/backend/maintenance_history/review",
                            'columns' => [
                                [
...
@push('css')
    <style type="text/css">
        ...
        #mh_tool tbody tr td:nth-child(16) {
            color: red;
        }
    </style>
@endpush
    ...
    <script type="text/javascript">
        ...
        dtapp.controller('ReviewToolController', function($scope, $http, $q) {
            ...
            $scope.submitForm = function () {
                ...
                var ajax_source = "/ajax/backend/maintenance_history/review?" + query_string;
                $('#mh_tool').DataTable().ajax.url(ajax_source).load();
                $('#error_area').show();
            }
        });
