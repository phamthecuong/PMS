...
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons modal-content" tabindex="-1" role="dialog" aria-describedby="dialog_simple" aria-labelledby="ui-id-50" id="{{ $id }}">
    <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
        ...
        <button class="ui-dialog-titlebar-close" ng-click="cancelRI()"></button>
    </div>
    <form>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    @include('custom.form_datepicker', [
                                                        ...
                                                        'model_name' => 'formAddRI.survey_time',
                                                ...
                                                <div class="col-lg-3">
                                                    @include('custom.form_select', [
                                                        ...
                                                        'model_name' => 'formAddRI.terrian_type_id',
                                                        'change' => 'loadDesignSpeedRI()'
                                                    ])
                                                </div>
                                                ...
                                                <div class="col-lg-2">
                                                    @include('custom.form_select', [
                                                        ...
                                                        'model_name' => 'formAddRI.road_class_id',
                                                        'change' => 'loadDesignSpeedRI()'
                                                    ])
                                                </div>
                                                <div class="col-lg-3">
                                                    {!! Form::lbText('design_speed_ri', 'N/A (km/h)', trans('back_end.design_speed'), '', trans('back_end.design_speed_hint'), [
                                                        'readonly', 
                                                        'ng-model' => 'formAddRI.design_speed',
                                                    ])!!}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="widget-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    @include('custom.form_number', [
                                                        ...
                                                        'model_name' => 'formAddRI.km_from',
                                                        'change' => 'updateActualLengthRI()'
                                                    ])
                                                </div>
                                                <div class="col-lg-3">
                                                    @include('custom.form_number', [
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 pull-right">
                                                    {!! Form::lbText('length_as_per_chainage', '', trans('back_end.Length as per Chainage'), '', '', ['readonly', 'ng-value' => 'Math.round(formAddRI.km_to *1000 + formAddRI.m_to - formAddRI.km_from*1000 - formAddRI.m_from + 0)'])!!}
                                                </div>
                                            </div>
                                        </div>     
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    @include('custom.form_select', [
                                                        ...
                                                        'model_name' => 'formAddRI.direction',
                                                        'change' => 'changeDirectionRI()'
                                                    ])
                                                </div>
                                                <div class="col-lg-3">
                                                    @include('custom.form_number', [
                                                        ...
                                                        'model_name' => 'formAddRI.lane_pos_number',
                                                    ])
                                                </div>
                                                <div class="col-lg-3">
                                                    @include('custom.form_number', [
                                                ...
                                                <div class="col-lg-3">
                                                    @include('custom.form_number', [
                                                        ...
                                                        'model_name' => 'formAddRI.lane_width',
                                                    ])
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    @include('custom.form_ympicker', [
                                                        ...
                                                        'model_name' => 'formAddRI.construct_year',
                                                    ])
                                                </div>
                                                <div class="col-lg-6">
                                                    @include('custom.form_ympicker', [
                                                        ...
                                                        'model_name' => 'formAddRI.service_start_year',
                                                    ])
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    @include('custom.form_number', [
                                                        ...
                                                        'model_name' => 'formAddRI.temperature',
                                                    ])
                                                </div>
                                                <div class="col-lg-4">
                                                    @include('custom.form_number', [
                                                        ...
                                                        'model_name' => 'formAddRI.annual_precipitation',
                                                    ])
                                                </div>
                                                <div class="col-lg-4">
                                                    @include('custom.form_number', [
                                                        ...
                                                        'model_name' => 'formAddRI.actual_length',
                                                    ])
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    @include('custom.form_select', [
                                                        ...
                                                        'model_name' => 'formAddRI.surface_id',
                                                        'disable' => true,
                                                    ])
                                                </div>
                                            </div>
                                                            ...
                                                            >
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if ($layer->id == 6)
                                                                        @include('custom.form_select', [
                                                                            ...
                                                                            'value' => '',
                                                                            'model_name' => "formAddRI.$name_material_type",
                                                                            'change_select' => 'loadSurfaceRI',
                                                                ...
                                                                <td>
                                                                    @include('custom.form_number', [
                                                                        ...
                                                                        'value' => '',
                                                                        'model_name' => "formAddRI.$name_thickness",
                                                                    ])
                                                                </td>
                                                                <td colspan="4">
                                                                    {!! 
                                                                        Form::lbText("data[$layer->id][desc]", null, null,'','', ['ng-model' => "formAddRI.$name_desc"])
                                                                    !!}
                                                                </td>
                                                            </tr>
                                                        @endforeach
        ...
        <div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
            <div class="ui-dialog-buttonset">
                 <!--Delete -->
                <button type="button" class="btn btn-danger" ng-show="formAddRI.id" click-btn-del="deleteRI()"><i class="fa fa-trash-o"></i>&nbsp;{{ trans('back_end.delete') }}</button>

                <!-- Edit -->
                <button type="button" class="btn btn-primary" ng-show="formAddRI.id" click-btn="editRI()"><i class="fa fa-pencil-square-o"></i>&nbsp;{{ trans('inputting.edit') }}</button>

                <!-- Add new -->
                <button class="btn btn-primary" ng-show="!formAddRI.id" click-btn="addRI()"><i class="fa fa-pencil-square-o"></i>&nbsp;{{ $button_complete }}</button>

                <!-- Cancel -->
                <button type="button" class="btn btn-default" id="close" ng-click="cancelRI()"><i class="fa fa-times"></i>&nbsp; {{ $button_cancel }}</button>
            </div>
        </div>
    </form>
</div>
