...
@section('content')
    @include('front-end.layouts.partials.heading', [
        ...
        'text2' => trans('back_end.ri_section_list')
    ])
    ...
    <section id="widget-grid">
            ...
            <div class="row">
                <article class="col-lg-12">
                    <div class="alert alert-success fade in">
                        ...
                        <a href="{!! url('/road_inventories/'.\Session::get('file_name').'/export_invalid') !!}"> {!! trans('back_end.download_here') !!}</a>
                        @endif
                    </div>
                </article>
            </div>
        @endif
        <div class="well">
            <a class="btn btn-success" href="{!! url('/road_inventories/import_data') !!}">
                {!! trans('back_end.import') !!}
            </a>
            <a class="btn btn-primary" href="{!! url('/admin/road_inventories/export') !!}">
                {!! trans('back_end.export') !!}
            </a>
        </div>
        <div class="row">
            <article class="col-lg-12">
                @box_open(trans("back_end.ri_list_panel_title"))
                <div>
                        ...
                        <div class="table-responsive">
                            ...
                            @include("custom.table_extra_data", [
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'data' => 'construct_year_col',
                                        'title' => trans('back_end.construct_year'),
                                        'name' => 'construct_year',
                                        'filterType' => "super_input",
                                    ],
                                    [
                                        'data' => 'service_start_year_col',
