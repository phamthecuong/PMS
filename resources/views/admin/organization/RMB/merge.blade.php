...
<div class="theme-showcase">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">{{trans('back_end.merge_RMB')}}</h3>
        </div>
        <div class="box-body">
            <div class="col-md-2" style="padding-left: 0px;">
            	<button type="button" class="btn btn-block btn-primary" onclick="check_merger();" >{{trans('back_end.merge_RMB')}}</button>
            </div>
        </div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel" style="text-align: center"> {{trans('organization.info_organization')}} </h4>
			</div>
			...
			<div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="merge({{$id}});">{{trans('menu.save')}}</button>
          </div>
		</div>
	</div>
</div>
...
/*end validate*/
	...
	function check_merger(){
    	...
    	if (segment.length < 2) {
    		// $("#myModal").modal('hide');
    		bootbox.alert("{{ trans('validation.please_choose_2_RMB')}}");
    	} else {
    		$("#myModal").modal('show');
    	}
	}
		        ...
		        callback: function(result) {
		        	...
		        	if (result == true) {
			        	$.post("{{route('MergeRMB')}}",
		       			...
		       			function(data) {
		       				if (data.code == 200) {
		       					location.href = '/organization' + '?name=1';
		       				} else {
