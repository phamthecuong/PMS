...
@if(isset($user))
        {!!Form::open(array('method' => 'POST', 'id' => 'submit' , 'route' => array('updateSB', $id)))!!}
    @else
        {!!Form::open(array('method' => 'POST', 'id' => 'submit' , 'route' => array('sbstore')))!!}
    @endif
<?php
    $values = '';
    if(isset($user))
...
<div class="theme-showcase">
    <?php 
        if (isset($c)) {
            ?>
            <div>
                <p>{{trans('back_en.The Name already exist')}}</p>
            </div>
         <?php   
        }
        if (isset($c)) {
    ...
    <div class="box">
        <div class="box-header">
            @if(!isset($user))
            <h3 class="box-title">{!!trans('back_end.add_new_SB')!!}</h3>
            @else
            <h3 class="box-title">{!!trans('back_end.edit_SB')!!}</h3>
            @endif
        </div>
        <div class="box-body">
             <div class="col-md-12 ">
